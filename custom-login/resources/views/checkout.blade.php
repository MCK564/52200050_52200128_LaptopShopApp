    ...
    <form action ={{ route('order.create') }} method="POST">
        ...
        <div class="flex flex-col ">
            ...
            <div class="my-2 grid sm:grid-cols-2 gap-3">
                <input type="text" name="receiver" placeholder="receiver's fullname" class=" border-gray-400 shadow-sm  rounded-md hover:border-gray-600 sm:col-span-1"/>       
                <input type="text" name="phone" placeholder="receriver's phone number" class="border-gray-400 shadow-sm rounded-md hover:border-gray-600 sm:col-span-1"/>       
                 <input type="text" name="address" class=" border-gray-400 shadow-sm rounded-md hover:border-gray-600 sm:col-span-2" placeholder="received address"/>
            </div>
           ...
           <div class="grid grid-cols-2 gap-3">
                ...
                <div class="sm:col-span-1 col-span-2 flex flex-col ">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <input  value="$ {{ $total_money }}" class="border-none text-end" disabled />
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-400">
                                tax:
                            </span>
                            <input  value="$ {{ $total_money/10 }}" class="border-none text-end" disabled />
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-400">
                                Total bill:
                            ...
                            <input value="{{ $total_money/10 }}" name="tax" class="hidden"/>

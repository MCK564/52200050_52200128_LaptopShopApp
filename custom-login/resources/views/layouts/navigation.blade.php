<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <x-nav-link class="md:flex md:items-center md:space-x-4 ">
                <form method="GET" action="{{ Auth::user()->user_type =='admin' ? route('admin_laptop.search') : route('laptop.search') }}" class="flex">
                    <input type="text" name="keyword" class="w-full px-4 py-3 rounded-l-full border border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Search..." required>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                {{-- <x-nav-link class="md:flex md:items-center md:space-x-4">
                    <form method="GET" action="" class="flex">
                        @csrf
                        <input type="text" name="keyword" class="w-full px-4 py-3 rounded-l-full border border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="Search..." required>
                        <button type="submit" class="px-4 py-3 bg-indigo-500 text-gray rounded-r-full hover:bg-indigo-600 focus:outline-none">
                            <svg class="h-6 w-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
                            </svg>
                        </button>
